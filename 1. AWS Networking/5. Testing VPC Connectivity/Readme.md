...
1. Connect to NextWork Public Server
My first connectivity test was whether I could connect to my network's Public Server9EC2 instance) which is "MyWork Public Server"

![Image](http://learn.nextwork.org/courageous_brown_peaceful_mermaid/uploads/aws-networks-connectivity_88727bef)
...
![Image](http://learn.nextwork.org/courageous_brown_peaceful_mermaid/uploads/aws-networks-connectivity_1cbb1b88)
